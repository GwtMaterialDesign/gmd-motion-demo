 ...
 * #L%
 */
package com.github.gwtmaterialdesign.client.application.home.products;
...
public class ProductListView extends ViewImpl implements ProductListPresenter.MyView {
    ...
    interface Binder extends UiBinder<Widget, ProductListView> {
    }
    ...
    @Inject
    ProductListView(Binder uiBinder) {
